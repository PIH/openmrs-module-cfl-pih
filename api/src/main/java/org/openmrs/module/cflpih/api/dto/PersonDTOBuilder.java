...
public class PersonDTOBuilder implements Serializable {
  ...
  public String getPersonLocation(Integer personId) {
    ...
    if (relatedPerson == null) {
      ...
      PersonAttribute location =
          relatedPerson.getAttribute(
              Context.getAdministrationService()
                  .getGlobalProperty(CflPIHConstants.PERSON_LOCATION_ATTRIBUTE_KEY));
  ...
  private PersonAttributeType getPersonIdentifierAttributeType() {
    String attributeTypeUUID =
        Context.getAdministrationService()
            .getGlobalProperty(CflPIHConstants.PERSON_IDENTIFIER_ATTRIBUTE_KEY);
    return StringUtils.isBlank(attributeTypeUUID)
        ? null
