 ...
 * The Condition Class.
 *
 * <p>The base interface for objects which are conditions supported by {@link QueryCriteria}.
 *
...
public interface Condition<R, D> {
   ...
   *
   * <p>The argument and result depend on specific implementation of the Condition.
   *
