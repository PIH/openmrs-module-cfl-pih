 ...
 *
 * <p>The converters are responsible for converting client data provided by in {@link
 * AdHocMessagePatientFilterDTO} to a collection of {@link Condition}s.
 *
 * <p>The concrete instances are configured to be used at Global Parameter: {@link
 * org.openmrs.module.cflpih.CflPIHConstants#AD_HOC_MESSAGE_PATIENT_FILTERS_CONFIGURATION_GP_KEY} .
 */
