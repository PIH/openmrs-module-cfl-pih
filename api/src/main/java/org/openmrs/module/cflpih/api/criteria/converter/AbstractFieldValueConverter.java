...
public abstract class AbstractFieldValueConverter
    implements PatientFilterConverter, PatientFilterConverterWithFieldPath {
  ...
  public void initFilter(Map<String, Object> properties) {
    try {
      ...
      throw new IllegalArgumentException(
          "The 'fieldPath' property must be a String, but was: "
              + properties.get(FIELD_PATH_PROP).getClass().getSimpleName(),
          cce);
    }
